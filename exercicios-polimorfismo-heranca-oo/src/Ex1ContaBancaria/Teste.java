...
public class Teste {
    ...
    public static void main(String[] args) {
        ...
        contaPoupacanca.setDiaRendimento(7);
    ...
    /*Como o metodo que vai se utilizar (MAIN) e estão todos dentro dessa classe,portando precisa
    utilizar o realizar saque como static também*/
